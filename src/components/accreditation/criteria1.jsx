    ...
    <div>
      <div className="topContainer">
        <div className="curriculum-container">
          ...
          <ul>
            <li onClick={() => handlePdfOpen("/assets/documents/accreditation/Criteria1/1.1.1.pdf")}>
              1.1.1 The Institution ensures effective curriculum delivery
              through a well-planned and documented process
            </li>
            <li onClick={() => handlePdfOpen("/assets/documents/accreditation/Criteria1/1.1.2.pdf")}>
              1.1.2 Number of certificate/diploma programs introduced during
              last five years
            </li>
            <li onClick={() => handlePdfOpen("/assets/documents/accreditation/Criteria1/1.1.3.pdf")}>
          ...
          <ul>
            <li>
              ...
              of courses across all programmes offered during the last five years
            </li>
            <li onClick={() => handlePdfOpen("/assets/documents/accreditation/Criteria1/1.2.2.pdf")}>
              1.2.2 Percentage of programmes in which Choice Based Credit
              System (CBCS)/elective course system has been implemented
              (current year data)
            </li>
            <li onClick={() => handlePdfOpen("/assets/documents/accreditation/Criteria1/1.2.3.pdf")}>
          ...
          <ul>
            <li onClick={() => handlePdfOpen("/assets/documents/accreditation/Criteria1/1.3.1.pdf")}>
            ...
            <li onClick={() => handlePdfOpen("/assets/documents/accreditation/Criteria1/1.3.2.pdf")}>
              1.3.2 Number of value-added courses imparting transferable and
              life skills offered during the last five years
            </li>
            <li onClick={() => handlePdfOpen("/assets/documents/accreditation/Criteria1/1.3.3.pdf")}>
          ...
          <ul>
            <li onClick={() => handlePdfOpen("/assets/documents/accreditation/Criteria1/1.4.1.pdf")}>
            ...
            <li onClick={() => handlePdfOpen("/assets/documents/accreditation/Criteria1/1.4.2.pdf")}>
              1.4.2 Feedback process of the Institution may be classified as follows:
                <ul>
                    <p> Feedback collected, analyzed and action taken and feedback available on website</p>
                <li onClick={() => handlePdfOpen("/assets/documents/accreditation/Criteria1/f1.pdf")}>
