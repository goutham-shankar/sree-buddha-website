...
const SectionTitle = ({ children }) => (
  <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6 pb-2 border-b border-amber-700">
    {children}
  </h2>
);
  ...
  >
    <div className="flex items-center justify-center mb-4">
      <div className="bg-amber-100 p-3 rounded-full">
        <span className="text-amber-800 text-2xl">{icon}</span>
      </div>
    </div>
...
export default function PlacementCell() {
  ...
  return (
    <div className="bg-gray-50 text-gray-800 font-['Poppins',sans-serif] min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          ...
          <div className="p-6 md:p-8">
            {/* About Section */}
            <section className="mb-12" aria-labelledby="placement-about">
            ...
            {/* Placement Officer */}
            <section className="mb-12" aria-labelledby="placement-officer">
              <SectionTitle>Placement Officer</SectionTitle>
              <motion.div
                className="bg-gray-50 rounded-lg p-6 shadow-md mb-10 flex flex-col md:flex-row items-center gap-8 border-l-4 border-amber-700"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.5 }}
              >
                <div className="min-w-[150px] w-[150px] object-cover h-[150px] relative rounded-full overflow-hidden border-4 border-amber-600">
                  <Image
                ...
                <div>
                  <h3 className="text-2xl font-semibold mb-2 text-gray-800">R. Pradeep Kumar</h3>
                  <p className="text-xl mb-4 text-amber-700">Placement Officer</p>
                  <div className="space-y-2 text-gray-600">
                    ...
                    <p className="flex items-center">
                      ...
                      <a href="mailto:placementcell@sbce.ac.in" className="hover:text-amber-700 transition-colors">
                    ...
                    <p className="flex items-center">
                      ...
                      <a href="mailto:sbceplacementcell@gmail.com" className="hover:text-amber-700 transition-colors">
                    ...
                    <p className="flex items-center">
                      ...
                      <a href="https://www.sbce.ac.in" target="_blank" rel="noopener noreferrer" className="hover:text-amber-700 transition-colors">
                        www.sbce.ac.in
                      </a>
                    </p>
                  </div>
            ...
            {/* Get In Touch */}
            <section className="mb-12" aria-labelledby="contact-options">
            ...
            <section className="mb-12" aria-labelledby="placement-stats">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                {[
                  ...
                  >
                    ...
                    <h3 className="text-3xl font-bold text-amber-800 mb-2">{stat.value}</h3>
          ...
          {/* Location Map */}
          <section className="p-6 md:p-8 bg-gray-50 border-t border-gray-200" aria-labelledby="map-location">
