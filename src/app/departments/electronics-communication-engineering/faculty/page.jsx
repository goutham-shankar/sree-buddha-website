...
export default function ComputerScienceDepartmentFaculty() {
    ...
    const faculty = [
        ["ece_faculty_1.jpg", "Ms. Pavitha P P", "B.Tech, M.Tech", "HoD", " Electronics"],
        ["ece_faculty_2.jpg", "Ms. Ambika Sekhar", "M.Tech", "Assistant Professor", " Microwave and Television Engineering"],
        ["ece_faculty_3.jpg", "Ms. Saritha N R", "M.Tech", "Assistant Professor", "Applied Electronics"],
        ["ece_faculty_4.jpg", "Mr. Sabi S", "M.Tech", "Assistant Professor", "Microwave and Television Engineering"],
        ["ece_faculty_5.jpg", "Ms. Jasmin Basheer", "M.Tech", "Assistant Professor", " Industrial Instrumentation and Control"],
        ["ece_faculty_6.jpg", "Ms. Pooja S Mohan", "M.Tech", "Assistant Professor", "Optoelectronics and Communication Systems "],
