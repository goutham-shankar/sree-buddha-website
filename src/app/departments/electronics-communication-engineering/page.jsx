...
export default function ElectronicsCommunicationDepartment() {
    return (
      <div className="cs-dept-container">
        ...
        <section className="cs-dept-gallery">
          ...
          <div className="cs-dept-gallery-grid">
            ...
            <div className="cs-dept-gallery-item">
              <Image 
                src="/images/eceimg3.jpg" 
                alt="Circuit Design Seminar"
                width={400}
                height={300}
              />
            </div>
