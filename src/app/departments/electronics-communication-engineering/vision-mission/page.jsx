...
export default function ElectronicsAndCommunicationVisionMission() {
  // SEO metadata
  const pageTitle = "Electronics and Communication Engineering - Vision and Mission";
  const pageDescription = "Learn about the vision and mission of the Electronics and Communication Engineering Department at Sree Buddha College of Engineering.";
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="/departments/electronics-communication" />
      </Head>
      ...
      <div className={`max-w-4xl mx-auto px-4 sm:px-6 py-8 md:py-12 ${poppins.variable} font-sans`}>
        ...
        >
          <motion.header variants={fadeIn} className="text-center mb-10">
            <h1 className="sr-only">Electronics and Communication Engineering Department</h1>
