...
export default function ElectronicsAndComputerVisionMission() {
  // SEO metadata
  const pageTitle = "Electronics and Computer Engineering - Vision and Mission";
  const pageDescription = "Learn about the vision and mission of the Electronics and Computer Engineering Department at Sree Buddha College of Engineering.";
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="/departments/electronics-computer" />
      </Head>
      ...
      <div className={`max-w-4xl mx-auto px-4 sm:px-6 py-8 md:py-12 ${poppins.variable} font-sans`}>
        ...
        >
          <motion.header variants={fadeIn} className="text-center mb-10">
            <h1 className="sr-only">Electronics and Computer Engineering Department</h1>
          ...
          >
            ...
            <p className="text-gray-600 leading-relaxed">
              To nurture professionally competent and socially responsible Electronics and Computer Engineers.
            </p>
          </motion.section>
