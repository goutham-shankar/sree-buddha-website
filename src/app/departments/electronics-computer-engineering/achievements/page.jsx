...
const GalleryImage = memo(({ num }) => (
    ...
    >
        <div className="relative w-full h-full">
            <Image
                src={`/assets/images/departments/achievements/er${num}.jpg`}
                alt={`Achievement ${num}`}
                fill
    ...
    const featuredAchievements = [
        {
            id: 1,
            image: "",
            description: " Chris G. Mathews, ER Department - Achieved 8.59 SGPA"
        },
    ...
    return (
        ...
        <div className="bg-white">
            ...
            <div className="md:hidden bg-yellow-800 sticky top-0 z-10">
                ...
                >
                    <option value="featured">Featured Toppers</option>
                            ...
                            <div className="flex flex-col lg:flex-row">
                                <div className="lg:w-1/2">
                                    <div className="relative h-64 md:h-80 lg:h-full w-full">
                                        <Image
                                            src="/assets/images/departments/achievements/achec.jpg"
                                            alt="Top Academic Performers - First Autonomous Batch"
                                            fill
                                ...
                                <div className="p-6 md:p-8 lg:w-1/2 flex flex-col justify-center">
                                    ...
                                    <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">First Semester Toppers</h3>
                                    <p className="text-base md:text-lg text-gray-700">
                                        Congratulations to our academic toppers from ECE and ER departments who achieved exceptional results in the First Semester B.Tech Degree Examinations of the First Autonomous Batch (2024-2028).
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="flex flex-col md:flex-row items-center">
                                ...
                                <div className="md:w-2/3 md:pl-12 text-center md:text-left">
                                    ...
                                    <div className="mb-4 flex flex-wrap justify-center md:justify-start gap-2">
                                        ...
                                        <span className="bg-yellow-100 text-yellow-900 text-sm font-medium px-3 py-1 rounded-full">B.Tech ER</span>
                                    </div>
                            ...
                            <div className="flex flex-col md:flex-row justify-between items-center mb-6">
                                <div className="mb-4 md:mb-0">
                                    <h4 className="text-lg font-medium text-gray-800">
                                        {showAllAchievements ?
                                            `Showing all ${otherAchievements.length} toppers` :
                                            `Showing 5 of ${otherAchievements.length} toppers`}
                                    </h4>
                                </div>
                                <div>
