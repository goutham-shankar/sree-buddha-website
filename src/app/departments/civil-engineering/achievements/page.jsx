...
const GalleryImage = memo(({ num }) => (
  ...
  >
    <div className="relative w-full h-full">
      <Image
        src={`/assets/images/departments/achievements/civil${num}.jpg`}
        alt={`Achievement ${num}`}
        fill
...
export default function CivilDepartmentAchievements() {
    ...
    const otherAchievements = [
        "Ms Gauri Shankar of 2017-21 Batch got qualified in GATE 2021 examination.",
        "Mr Sam Koshy and Ms. Divya Mohan of 2017-21 batch, Ms. Shana N and Ms Livya Rachel Philip of 2018-22 batch, Mr Sooraj Kumar S and Mr. S Balasankar of 2019-23 batch and Mr Abhishankar A R and Ms Kaladevi S of 2020-24 batch bagged fourth position in the DISEGNO competition conducted by CET & ICI consisting of 12 teams from various colleges under KTU.",
        "Ms Gauri Shankar of 2017-21 Batch secured 10 SGPA in first, sixth, seventh and eighth semesters of KTU B Tech degree examination.",
        "Ms Devagayathry S of 2017-21 Batch secured 10 SGPA in sixth, seventh and eighth semesters of KTU B Tech degree examination.",
        "Ms Shana N of 2018-22 Batch secured 10 SGPA in third, fourth and fifth semesters of KTU B Tech degree examination.",
        "Ms Erin Mariam Shaji of 2019-23 Batch secured 10 SGPA in first and second semesters of KTU B Tech degree examination.",
        "Ms Sreelekshmi M of 2015-19 Batch B.Tech has won first prize for best paper in SPICE '20, National Conference.",
        "Mr Sooraj S of 2018-20 Batch M.Tech has won the second best paper award in SPICE '20, National Conference.",
        "The Civil Engineering department secured second position in the First year KTU results 2018.",
        "The department also secured second position in the Final year Kerala University results 2018.",
        "Ms. Gouri Shankar, secured a glorious 10 GPA for the Semester 1 KTU Examination (December 2017) result."
    ];
    ...
    const featuredAchievements = [
        {
            id: 1,
            image: "/assets/images/departments/achievements/civil_achievements1.jpg",
            description: "Ms Gauri Shankar of 2017-21 Batch secured 10 SGPA in first, sixth, seventh and eighth semesters of KTU B Tech degree examination and qualified for GATE 2021."
        },
        {
            id: 2,
            image: "/assets/images/departments/achievements/civil_achievements2.jpg",
            description: "Civil Department team bagged fourth position in the DISEGNO competition conducted by CET & ICI consisting of 12 teams from various colleges under KTU."
        },
        {
            id: 3,
            image: "/assets/images/departments/achievements/civil_achievements3.jpg",
            description: "Ms Sreelekshmi M of 2015-19 Batch B.Tech has won first prize for best paper in SPICE '20, National Conference."
        }
    ];
                                ...
                                <div className="flex flex-col lg:flex-row">
                                    <div className="lg:w-1/2">
                                        <div className="relative h-64 md:h-80 lg:h-full w-full">
                                            <Image
                                                src="/assets/images/departments/achievements/civil_achievements5.jpg"
                                                alt="Sevena Reksha Award - Midhun Lal"
                                                fill
                                    ...
                                    <div className="p-6 md:p-8 lg:w-1/2 flex flex-col justify-center">
                                        ...
                                        <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">Sevena Reksha Award Recipient</h3>
                                        <p className="text-base md:text-lg text-gray-700">
                                            Mr. Midhun Lal, seventh semester, Civil department received the Sevena Reksha award from National Secular Congress at Jaya Bharath college, Perumbavoor for his commitment and sincerity as a volunteer and coordinator at civil station, Kakkanad and his participation in relief activities in different districts.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-xl shadow-lg overflow-hidden p-6 md:p-8 border border-gray-200">
                                <div className="flex flex-col md:flex-row items-center">
                                    <div className="md:w-1/3 flex justify-center mb-6 md:mb-0">
                                        <div className="relative">
                                            <div className="relative w-48 h-48 md:w-56 md:h-56 rounded-full overflow-hidden border-4 border-yellow-500">
                                                <Image
                                                    src="/assets/images/departments/achievements/civil_achievements4.jpg"
                                                    alt="Gauri Shankar"
                                                    fill
                                    ...
                                    <div className="md:w-2/3 md:pl-12 text-center md:text-left">
                                        <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3">GAURI SHANKAR</h3>
                                        <div className="mb-4 flex flex-wrap justify-center md:justify-start gap-2">
                                            ...
                                            <span className="bg-yellow-100 text-yellow-900 text-sm font-medium px-3 py-1 rounded-full">B.Tech Civil</span>
                                            <span className="bg-yellow-100 text-yellow-900 text-sm font-medium px-3 py-1 rounded-full">GATE Qualified</span>
                                        </div>
                                        <p className="text-gray-700 text-base md:text-lg">
                                            Ms. Gauri Shankar of 2017-21 Batch secured perfect 10 SGPA in first, sixth, seventh and eighth semesters of KTU B.Tech Civil Engineering degree examination. The department was adorned with pride and honor when she secured a glorious 10 GPA for the Semester 1 KTU Examination (December 2017). She also qualified in GATE 2021 examination.
                                        </p>
                                    </div>
                                </div>
                            </div>
