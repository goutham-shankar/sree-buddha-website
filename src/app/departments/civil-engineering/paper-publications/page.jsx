...
const SectionTitle = ({ children }) => (
  <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center text-gray-900 mb-2 px-2">
    {children}
  </h2>
);
...
const SectionSubtitle = ({ children }) => (
  <div className="flex justify-center items-center mb-8 md:mb-12 px-4">
    <div className="w-8 sm:w-12 md:w-16 h-1 bg-yellow-900 mr-2 sm:mr-4 hidden sm:block"></div>
    <h3 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-700 text-center">
      {children}
    </h3>
    <div className="w-8 sm:w-12 md:w-16 h-1 bg-yellow-900 ml-2 sm:ml-4 hidden sm:block"></div>
  </div>
);
...
const PublicationCard = ({ publication, highlight = false }) => {
  ...
  return (
    <motion.div
      className={`p-4 sm:p-6 rounded-lg shadow-md mb-6 hover:bg-yellow-50 ${cardClasses} transition-all duration-300`}
    ...
    >
      <div className="flex flex-col lg:flex-row justify-between">
        ...
        <div className="flex flex-row  lg:flex-col lg:w-1/6 items-start sm:items-end justify-between lg:justify-center mt-4 lg:mt-0">
          <div className="bg-yellow-100 text-yellow-900 px-2 sm:px-3 py-1 rounded-full text-center text-xs sm:text-sm font-medium mb-0 lg:mb-2">
          ...
          {publication.featured && (
            <div className="mt-0 lg:mt-2 ml-2 lg:ml-0 text-xs bg-yellow-900 text-white px-2 py-1 rounded">
              Featured
            </div>
          )}
        </div>
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-12">
      <div className="bg-white rounded-xl p-4 sm:p-6 shadow-md hover:shadow-lg transition-shadow border border-gray-100">
        ...
        <div className="text-gray-700 text-sm sm:text-base">Total Publications</div>
      </div>
      <div className="bg-white rounded-xl p-4 sm:p-6 shadow-md hover:shadow-lg transition-shadow border border-gray-100">
        <div className="flex justify-between items-center">
          <div>
            <div className="text-2xl sm:text-4xl font-bold text-yellow-900 mb-1 sm:mb-2">{stats.journalPubs}</div>
            <div className="text-gray-700 text-sm sm:text-base">Journals</div>
          </div>
          <div>
            <div className="text-2xl sm:text-4xl font-bold text-yellow-900 mb-1 sm:mb-2">{stats.conferencePubs}</div>
            <div className="text-gray-700 text-sm sm:text-base">Conferences</div>
          </div>
          {stats.bookChapterPubs > 0 && (
            <div>
              <div className="text-2xl sm:text-4xl font-bold text-yellow-900 mb-1 sm:mb-2">{stats.bookChapterPubs}</div>
              <div className="text-gray-700 text-sm sm:text-base">Book Chapters</div>
            </div>
          )}
        </div>
      </div>
      <div className="bg-white rounded-xl p-4 sm:p-6 shadow-md hover:shadow-lg transition-shadow border border-gray-100 sm:col-span-2 md:col-span-1">
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <header className="relative bg-gradient-to-b from-yellow-50 to-white">
        <div className="relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-8 sm:py-12 md:py-16">
            ...
            <div className="w-24 sm:w-32 md:w-40 h-1 bg-yellow-900 mx-auto mb-6 sm:mb-8" aria-hidden="true" />
      ...
      <button
        ...
        className="fixed bottom-4 sm:bottom-8 right-4 sm:right-8 p-1.5 sm:p-2 rounded-full bg-yellow-900 text-white shadow-lg hover:bg-yellow-800 transition-colors"
