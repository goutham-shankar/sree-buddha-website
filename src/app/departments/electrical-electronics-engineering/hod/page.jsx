...
export default function ElectricalElectronicsDepartmentHOD() {
  ...
  const tabData = {
    education: {
      ...
      content: [
        'Ph.D. in Power System Optimization - SIMATS University, Chennai',
    ...
    experience: {
      ...
      timeline: [
        { period: '2017 - Present', role: 'HOD, Department of EEE, Sree Buddha College of Engineering' },
        { period: '2008 - 2017', role: 'Faculty, Electrical & Electronics Engineering' },
        { period: '2005 - 2008', role: 'Industry Experience' }
      ]
    },
    research: {
      ...
      achievements: [
        ...
        'Guided various UG and PG projects',
        'Guided funded projects',
        'Actively involved in student startups',
        'Specialization in Power System Optimization'
      ]
    }
  };
            ...
            <AnimatedSection delay={0.4}>
                ...
                {activeTab === 'experience' && (
                  <InfoCard title="Professional Experience" icon={tabData.experience.icon}>
                    ...
                    <div className="mt-6 text-gray-700">
                      <p>Dr. Vinod V P has a total of 20 years of experience, with 17 years in teaching and 3 years in industry. He took charge as Head of the Department on 17th August 2017.</p>
                    </div>
                  </InfoCard>
                )}
              ...
              >
                ...
                <p className="text-gray-700 leading-relaxed">
                  Dr. Vinod V P received his doctoral degree in Power System Optimization from SIMATS University, Chennai, 
                  completed his post graduation in Power System and graduation in Electrical & Electronics Engineering. 
                  He has 20 years of experience out of which 17 years in teaching and 3 years in industry. 
                  He guided various UG and PG projects and is a lifetime member of ISTE. 
                  He also had guided funded projects and is actively involved in student startups. 
                  He took charge as Head of the Department on 17th August 2017.
                </p>
              </motion.div>
            </AnimatedSection>
          </div>
