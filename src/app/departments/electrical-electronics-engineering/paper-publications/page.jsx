...
const publicationsData = [
  {
    id: 1,
    authors: ["Amjith S", "Ananthu Vijayakumar"],
    title: "An Induction Generator Based Hybrid Power Generation System For Aircraft",
    publication: "Engineering Education for Facing the Future 2018 (E2F2 2018) National Conference on Emerging Trends in Green Electrical Technologies (NCEGET'18)",
    details: "April 2018",
    year: 2018,
    type: "conference"
  },
  {
    ...
    authors: ["Amjith S", "Ananthu Vijayakumar"],
    title: "An Induction Generator Based Hybrid Power Generation System For Aircraft",
    publication: "National Conference on Future Technologies in Power, Control & Communication Systems (NFTPCOS) 2018",
    details: "March 2018 (Accepted for publication)",
    year: 2018,
    type: "conference"
  },
  {
    ...
    authors: ["Amjith S", "Ananthu Vijayakumar"],
    title: "An Induction Generator Based Hybrid Power Generation System For Aircraft",
    publication: "National Conference on Emerging Technologies (NACET 2018)",
    details: "March 2018",
    year: 2018,
    type: "conference"
  },
  {
    id: 4,
    authors: ["Amritha Anand", "Nandan G"],
    title: "A Novel Method of Energy Regeneration in Electric Vehicle",
    publication: "National Conference on Future Technologies in Power control and communications (NFTPCOS-18), College of Engineering Perumon",
    details: "Vol.1 March 2018 (Accepted in the International Journal of Innovative Research in Electrical Electronics and Communication Engineering Vol.1, Special issue march-2018)",
    year: 2018,
    type: "conference"
  },
  {
    id: 5,
    authors: ["Amritha Anand", "Nandan G", "Sooraj O S"],
    title: "Effective utilization of regenerative braking in electric vehicle 2018",
    publication: "Kerala Technological Conference (KETCON) National Conference Proceedings",
    details: "February 2018, ISBN Number: 978-93-5300-630-3",
    year: 2018,
    type: "conference"
  },
  {
    id: 6,
    authors: ["Amritha Anand", "Nandan G"],
    title: "An Energy Efficient Regenerative Braking System",
    publication: "IEEE International Multi-conference on Computing, Communication, Electrical and Nano Technology, Mangalam College of Engineering, Ettumanoor",
    details: "April 2018 (Accepted for publication)",
    year: 2018,
    type: "conference"
  },
  {
    id: 7,
    authors: ["Amritha Anand", "Nandan G"],
    title: "A Bi-directional Buck-Boost Converter for Energy Efficient Regenerative Braking System",
    publication: "Annual conference series on Engineering education for facing the future, Sree Buddha College of Engineering",
    details: "April 2018",
    year: 2018,
    type: "conference"
  },
  {
    id: 8,
    authors: ["Anagha Basheer", "Sindhu V"],
    title: "Reduction of Torque Ripples in Three-Phase Four Switch Inverter-Fed PMSM Drives using Space Vector Pulse width Modulation",
    publication: "National conference on Kerala Technological Conference (KETCON'18) at Sahrdaya College of Engineering and Technology, Thrissur",
    details: "February 23, 2018",
    year: 2018,
    type: "conference"
  },
  {
    id: 9,
    authors: ["Anagha Basheer", "Sindhu V"],
    title: "Reduction of Torque Ripples in Three-Phase Four Switch Inverter-Fed PMSM Drives using Sliding Mode Controller",
    publication: "National conference on future technologies in power control & communication systems (NFTPCOS'18) at College of Engineering, Perumon",
    details: "March 17, 2018",
    year: 2018,
    type: "conference"
  },
  {
    id: 10,
    authors: ["Anagha Basheer", "Sindhu V"],
    title: "A Novel Approach for Reduction of Torque Ripples in Three-Phase Four Switch Inverter-Fed PMSM Drives using Sliding Mode Controller",
    publication: "National conference on emerging trends in green electrical technologies (NCEGET'18) at Sree Buddha College of Engineering, Pattoor",
    details: "April 17, 2018",
    year: 2018,
    type: "conference"
  }
];
...
// Main component
export default function EEEPaperPublications() {
