...
export default function ComputerScienceDepartmentActivities() {
  ...
  // Combined activities from both arrays, using the EEE activities and removing duplicates
  const activities = [
    {
      id: 1,
      ...
      image: "/assets/images/departments/activities/eec.jpg",
    ...
    },
    {
      ...
      image: "/assets/images/departments/activities/eec2.jpg",
    ...
    },
    {
      ...
      image: "/assets/images/departments/activities/eec3.jpg",
  ...
  // Updated categories to include seminar
  const categories = [
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {activities.filter(a => new Date(a.date) > new Date()).slice(0, 4).map((activity) => (
