  ...
  const activities = [
    {
      ...
      category: "workshop",
      date: "March 15, 2025",
      location: "Bio Technology & Biochemical  Lab",
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-center text-gray-900 mb-4">
              Department Of Bio Technology & Biochemical  Engineering
            </h1>
        ...
        <div className="mb-12">
          <div className="bg-yellow-50 rounded-lg p-6 shadow-sm">
            ...
            <p className="text-gray-700">
              The Department of Bio Technology & Biochemical  Engineering at Sree Buddha College of Engineering conducts 
