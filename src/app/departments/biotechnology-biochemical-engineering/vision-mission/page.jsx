...
export default function MechanicalEngineeringVisionMission() {
    // SEO metadata
    const pageTitle = "Mechanical Engineering - Vision and Mission";
    const pageDescription = "Learn about the vision and mission of the Mechanical Engineering Department at Sree Buddha College of Engineering.";
    ...
    return (
        <>
            <Head>
                ...
                <link rel="canonical" href="/departments/mechanical-engineering" />
            </Head>
            ...
            <div className={`max-w-4xl mx-auto px-4 sm:px-6 py-8 md:py-12 ${poppins.variable} font-sans`}>
                ...
                >
                    <motion.header variants={fadeIn} className="text-center mb-10">
                        <h1 className="sr-only">Mechanical Engineering Department</h1>
                    ...
                    >
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            To nurture research oriented Biotechnology and Biochemical Engineers to address social needs.
                        </p>
                    </motion.section>
