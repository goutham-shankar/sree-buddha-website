...
export default function ComputerScienceDepartmentHOD() {
    return (
        <>
            ...
            <p>
            Welcome to the Department of Food Technology at Sree Buddha College of Engineering, which was started in the year 2020 to commemorate the VISION 2020 of late Bharat Ratna Dr. APJ Abdul Kalam (Former Hon’ble President of India, Scientist and Academician), committing to advancements in research and education in the field of Food Technology.  Food Technology is not confined to science, technology, engineering, or management since it has a wide range of scope and multidimensional in various applications. Our SBCE management run by academicians envisioned the department of Food Technology because of the present and future demands in various sectors of food and allied processing arena.
            </p>
