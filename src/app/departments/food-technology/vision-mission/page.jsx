...
export default function FoodTechnologyVisionMission() {
  return (
      ...
      <div className="space-y-8 md:space-y-10">
        ...
        <section>
          ...
          <ul className="text-gray-600 leading-relaxed list-disc ml-6 space-y-2">
            <li>To emphasize the development of graduates with a professional approach.</li>
            <li>To perform research with an insight towards lifelong learning, entrepreneurship, and environmental sustainability.</li>
            <li>To equip students with innovative product and technology development skills.</li>
          </ul>
        </section>
      </div>
