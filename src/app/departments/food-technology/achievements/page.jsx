...
const GalleryImage = memo(({ num }) => (
    ...
    >
        <div className="relative w-full h-full">
            <Image
                src={`/assets/images/departments/achievements/food_technology_achievements_${num}.jpg`}
                alt={`Achievement ${num}`}
                fill
    ...
    const featuredAchievements = [
        {
            id: 1,
            image: "",
            description: " Devi Priya, FT Department - Achieved 8.38 SGPA"
        },
                            ...
                            <div className="flex flex-col lg:flex-row">
                                <div className="lg:w-1/2">
                                    <div className="relative h-64 md:h-80 lg:h-full w-full">
                                        <Image
                                            src="/assets/images/departments/achievements/ft.jpg"
                                ...
                                <div className="p-6 md:p-8 lg:w-1/2 flex flex-col justify-center">
                                    ...
                                    <p className="text-base md:text-lg text-gray-700">
                                        Congratulations to our academic toppers from Food Technology department who achieved exceptional results in the First Semester B.Tech Degree Examinations of the First Autonomous Batch (2024-2028).
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="flex flex-col md:flex-row items-center">
                                ...
                                <div className="md:w-2/3 md:pl-12 text-center md:text-left">
                                    ...
                                    <div className="mb-4 flex flex-wrap justify-center md:justify-start gap-2">
                                        ...
                                        <span className="bg-yellow-100 text-yellow-900 text-sm font-medium px-3 py-1 rounded-full">B.Tech FT</span>
                                    </div>
