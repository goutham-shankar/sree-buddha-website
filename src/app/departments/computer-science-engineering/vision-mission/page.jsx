...
export default function VisionMissionSection() {
  // SEO metadata
  const pageTitle = "Computer Science Department - Vision and Mission";
  const pageDescription = "Learn about the vision and mission of the Computer Science Engineering Department at Sree Buddha College of Engineering.";
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="/departments/computer-science" />
      </Head>
      ...
      <div className={`max-w-4xl mx-auto px-4 sm:px-6 py-8 md:py-12 ${poppins.variable} font-sans`}>
        ...
        >
          <motion.header variants={fadeIn} className="text-center mb-10">
            <h1 className="sr-only">Computer Science Department</h1>
          ...
          >
            ...
            <ul className="text-gray-600 leading-relaxed space-y-3 list-disc pl-5">
              <li>Provide student-centric learning environment to create competent Computer Engineers</li>
              <li>Instigate research, innovation and entrepreneurship initiatives</li>
              <li>Impart skills and creative thinking ability to promote lifelong learning.</li>
            </ul>
          </motion.section>
        </motion.div>
      </div>
