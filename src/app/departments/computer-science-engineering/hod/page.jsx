...
<div className="flex items-center text-gray-700 mt-2">
  ...
  <a href={profileData.linkedinUrl} target="_blank" rel="noopener noreferrer" className="hover:cursor-pointer text-blue-500">
    {profileData.linkedinProfile || 'LinkedIn Profile'}
  </a>
</div>
                </div>
              </motion.div>
