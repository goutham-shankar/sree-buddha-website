    ...
    <div className="container">
      <div className="page">
        ...
        <div className="paragraph">
          <span className="name">Sree Buddha College of Engineering</span>
          <span>, affiliated
          to APJ Abdul Kalam Technological University, has been par excellence
          in technical education.</span> The sermons of Lord Buddha gave us a lead to
          ...
          Autonomy by the UGC from 2024-25 Academic Year onwards <br />
          <br />
